...
mInact=
(
Account disabled due to inactivity. Reactivated and advised to wait 10 min before logging in.
)
SendInput, %mInact%
return
...
msAuthen=
(
User requesting assistance with MS Authenticator Setup / Acces. Walked user through setup process.
)
SendInput,%msAuthen%
return
